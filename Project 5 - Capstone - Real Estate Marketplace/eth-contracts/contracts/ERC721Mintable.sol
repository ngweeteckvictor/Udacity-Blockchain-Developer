...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Ownable: invalid new owner's address");
        _owner = newOwner;
...
contract Pausable is Ownable {
    ...
    function setPaused() external onlyOwner whenNotPaused {
        _paused = true;
        emit Paused(msg.sender);
    }

    function setUnpaused() external onlyOwner paused {
        _paused = false;
    ...
    modifier paused() {
        require(_paused, "Pausable: contract is currently not paused");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != ownerOf(tokenId),
            "ERC721: address is already the owner of the token"
        );
        ...
        require(
            ...
            "ERC721: caller is not the owner of the contract or not approved by the owner of the token"
        );
    ...
    function _mint(address to, uint256 tokenId) internal virtual {
        ...
        require(to != address(0), "ERC721: invalid to address");
    ...
    function _transferFrom(
        ...
        require(
            ...
            "ERC721: from address is not the owner of the given token"
        );
...
contract ERC721Metadata is ERC721Enumerable {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "ERC721Metadata: token does not exists");
